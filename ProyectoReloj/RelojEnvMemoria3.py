...
class RelojSimHierbaEnv(gym.GoalEnv):
    ...
    def __init__(self):
        ...
        ## Mapa .. esta parte no entra en los datos analizados
        self.MaxX = 110  # cm
        self.MinX = 20
        self.MaxY = 20  # cm
     ...
     #   print("Arco MAXImo", self.ArcoMaximo)
       ...
       # self.AumentoCamara = 0.3  # cm/cm   ## la relacion entre la  camara(cm) y la altura o "POSY" (cm)
        ...
        self.fondo = cv2.imread("C:/Users/jorge/Desktop/PycharmProjects/ProyectoReloj/Imagenes/tierra/fondos/images.jpg", cv2.IMREAD_COLOR)
        ...
        self.RangoRecompensaFinal = -0.05
    ...
    def ProcesarImagen(self,camara):
        ...
        if self.VelocidadA < self.VelocidadAMaxima * 0.2 or self.VelocidadA > self.VelocidadAMinima * 0.2:
            ...
            try:
                ...
                camara, Detectando,self.PosXDetectado, self.PosYDetectado, self.PosZDetectado, self.FMx, self.FMy, \
                self.FMd,xmarca,ymarca, self.Tx, self.Ty, self.PMx, self.PMy, self.PMd = \
